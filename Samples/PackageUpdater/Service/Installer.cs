//===========================================================================
// MODULE:  Installer.cs
// PURPOSE: installer for the package updater Windows service
// 
// Copyright © 2012
...
{
   /// <summary>
   /// Package updater service installer
   /// </summary>
   /// <remarks>
   ...
   public sealed class Installer : System.Configuration.Install.Installer
   {
      ...
      public Installer ()
      {
         ...
         Installers.Add(
            ...
            {
               ServiceName = "NLogEx.Samples.PackageUpdater",
               Description = "NuGet Automatic Package Updater",
